      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-semibold tracking-tight">SeaJobs</span>
          </div>

          <nav className="hidden md:flex items-center gap-6 text-slate-700">
            <a href="#jobs" className="hover:text-blue-600">Вакансии</a>
            <a href="#about" className="hover:text-blue-600">О проекте</a>
        ...
        {open && (
          <div className="md:hidden pb-4">
            <div className="grid gap-2">
              ...
              <a href="#about" className="rounded-md px-3 py-2 hover:bg-slate-100">О проекте</a>
              <a href="#contact" className="rounded-md px-3 py-2 hover:bg-slate-100">Контакты</a>
